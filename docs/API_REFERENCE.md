...
### PATCH `/admin/enterprise-plan/invites/:id`
...
```json
{
  ...
  "billingCycle": "MONTHLY",
  "expiresInDays": 14,
  "internalNotes": "Updated quote after scope change."
}
```

Updates the linked custom plan, enterprise proposal, and invite snapshot together.
